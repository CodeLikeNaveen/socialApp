        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              ...
              <p>Used by abnormal People</p>
            </div>
          </div>
          <h1 className='text-3x1 md:text-6xl md:pb-2 font-bold bg-linear-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More than something that truly connect</h1>

          <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>connet with someone at least on SocialApp</p>
        </div>
