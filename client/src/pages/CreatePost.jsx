    ...
    <div className='min-h-screen bg-linear-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Connect with amazing people and grow you network</p>
        </div>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
            ...
            images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
              {images.map((image, i) => (
                <div key={i} className='relative group'>
                  ...
                  <div onClick={() => setImages(images.filter(
                    (_, index) => index !== i)
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <input type="file" id="images" accept=' image/*' hidden multiple onChange={
