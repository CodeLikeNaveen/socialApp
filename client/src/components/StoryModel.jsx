...
const StoryModel = ({ setShowModel, fetchStories }) => {
    ...
    return (
        <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blurtext-white flex items-center justify-center p-4 text-white'>
            <div className='w-full max-w-md' >
                ...
                <div className='rounded-1g h-96 flex items-center justify-center relative' style={{ backgroundColor: background }}>

                    {mode === 'text' && (
                        <textarea
                            className='bg-transparent text-white w-full h-full p-6 text-1g resize-none focus : outline-none'
